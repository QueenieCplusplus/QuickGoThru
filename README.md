...
本儲存庫保留以往 C++ 高階程式語言、Python 腳本特色、資料擷取和封包嗅探 Data Mining & Web Crawler，亦包含 Data Structure、DBA、Search Engine 的研究著作，尚包羅資安議題 IT Security & Hack on Browser，未來將主攻『 雲端技術 』與 『 手機技術 』的結合
