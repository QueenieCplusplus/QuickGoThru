...
本儲存庫保留以往 C++ 高階程式語言、Python 腳本特色、資料擷取（和嗅探） Data Mining & Web Crawler，亦包含 Data Structure、DBA (Search Engine) 的研究著作，尚包羅資安議題 IT Security & Hack on Browser，未來將主攻『 雲端技術 https://github.com/QueenieCplusplus/QuickGoThru/blob/master/README.md#gcp-cloud-tech-in-2020 
...
科技業冷僻產品如果結合大家知道的現有通俗知識做比喻作敘述，會增進理解，更容易接受他。
  ...
  而GG就是世界物業大亨，他擁有全世界各種地段、品質、家具的膠囊套房。
