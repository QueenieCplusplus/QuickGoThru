...
雖然目前是行動裝置時代，然而行動裝置僅能做客戶端設備顯示使用，運算能力集中在雲端上，透過網路互相連接，故科技時代的 2016 年之後，尤其 2018 年到防疫而需要遠端工作的今年，未來的科技業展開新革命：手機應用程式行動支付）、雲端運算(PaaS)、虛擬化後端。
...
科技業冷僻產品如果結合大家知道的現有通俗知識做比喻作敘述，會增進理解，更容易接受他。
  ...
  一. 正在為網站找家的人，執行環境，因為沒錢買樓所以當租客。
  二. 已經有房子但因為知道時局又識大體的人 從郊外的房換到城市租房  享受更高的交通品質 所以搬家。

  我們就是像是科技的房屋仲介 要為第一種客戶找適合他住的房。
  為第二種 （通常他也找好租屋）為他做搬遷 幫她搬遷打包等瑣碎事宜。

  而GG就是世界物業大亨，他擁有全世界各種地段 品質 家具的 膠囊套房。

  ＧCE:
  這類似VM 但是內容物如額外怎樣的配置 就是房客自己管理 購買~
  ...
  GKE :
  好比陽明海運或是長榮貨機對各種物品測量 打包和 運輸有運籌知識的專家。
