本儲存庫繼續保留以往 C++ 高階程式語言和 Python 腳本特色和資料擷取和嗅探 Data Mining，且包含 Data Structure、Search Engine、DBA 的相關研究著作，議題尚包羅 IT Security & Hack on Browser & Netwroking ，未來將主攻雲端技術 Cloud Service ，敬請拭目以待。 ：）
