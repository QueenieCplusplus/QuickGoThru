...
本儲存庫將繼續保留 C++ 原始的研究，並且現在會以 Data Structuture 的研究 ，以及搜索引擎 Search Engine 的應用為主，未來則將專注資料分析處理 Data Analysis 包含擷取與探勘 Data Mining 和資訊安全與駭客技術 Hack on Browser 為主要研究議題。

既然我已經不是過去的我，那傻妞 Patty & 歷經滄桑的 Kate，我是有能力駕馭難度更高技術的 Queenie，要感謝過去的努力的自己，造就現在面對一切更為輕鬆的我，放眼未來的技術才是，所以那些無奈被迫隱藏的智財庫，就當消失唄！
