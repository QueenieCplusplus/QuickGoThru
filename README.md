本儲存庫保留以往 C++ 高階程式語言、Python 腳本特色、資料擷取（和嗅探） Data Mining，亦包含 Data Structure、DBA (Search Engine) 的研究著作，議題尚包羅 IT Security & Hack on Browser，未來將主攻雲端技術 Cloud Service & Networking，敬請拭目以待。 ：）
