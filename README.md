...
寫回三年前的安卓，應該是當初版主曾發過宣言說要嫁給安卓先生 (真是一語成籖)，版主在學習安卓時正好就是系統 O-P 時代，Google 於 2018 年夏天大力推行 Kotlin 取代 Java，感受到此語言的人性化與流暢，與 Java 產生鮮明對比，如今此語言的生態系發展純熟。系統 O 時代因為直播串流崛起，注重鏡像畫面等功能，而系統 P 正值 2019 年科技巨頭被大眾點名要保障個人隱私的年份，所以注重於在設備使用上詢問使用者權限問題。安卓系統從 2020 年開始，慣用的甜品命名方式將被數字取代，所以 QueensCacke 改為 Q，2021 年則為系統數字 30，綜觀 30 年，手機系統的變化速度一直都是跟世界潮流走的，可以算是進步速度最快的科技產品。
