...
感受到此語言的人性化與流暢，與 Java 產生鮮明對比，如今此語言的生態系發展純熟。系統 O 時代因為直播串流崛起，注重鏡像畫面等功能，而系統 P 正值 2019 年科技巨頭被大眾點名要保障個人隱私的年份，所以注重於在設備使用上詢問使用者權限問題。手機系統的變化速度一直都是跟世界潮流走的，可以算是進步速度的科技產品。
